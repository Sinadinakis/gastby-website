...
const NotFoundPage = () => {
  ...
  <h1 className="mb-6 text-red-800 text-5xl mx-auto max-w-lg text-center leading-relaxed">{formatMessage(notFoundMessages.header)}</h1>
          <p className="mb-6 text-gray-800 mx-auto max-w-lg text-center leading-relaxed">{formatMessage(notFoundMessages.content)}</p>
        </div>
      </div>
      <Footer />
    </>
